...
from .views import CantidadDeUsuariosView, CantidadProductosView, CategoriaView, ComprasView, OperacionView, OrdenView, ProductoDestacadoView, ProductoView, SumaVentasView, UsuariosView
